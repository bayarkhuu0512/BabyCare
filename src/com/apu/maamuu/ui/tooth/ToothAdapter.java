package com.apu.maamuu.ui.tooth;
...
public class ToothAdapter extends RecyclerView.Adapter<ToothAdapter.ViewHolder> {
	String LOG_TAG = ToothAdapter.class.getName();
	private Context mContext;
	private List<Timeline> mList;
	private Typeface roboto_light;

	public ToothAdapter(Context context, List<Timeline> list) {
		mContext = context;
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.tooth_row, parent, false);
