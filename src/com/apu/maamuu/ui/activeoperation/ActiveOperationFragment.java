package com.apu.maamuu.ui.activeoperation;
...
public class ActiveOperationFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.activeoperation_view, container, false);
		...
		ActiveOperationAdapter adapter = new ActiveOperationAdapter(getActivity(), list);
