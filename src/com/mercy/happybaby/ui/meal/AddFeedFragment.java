...
public class AddFeedFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		feedListAdapter = new FeedListAdapter(getActivity(), feedNames);
	...
	private void addFeed() {
		Log.d(LOG_TAG, "Ml " + Integer.parseInt(feedML.getText().toString()));
		crtnMsg.hide();
		...
		feed2.setAmount(1);
		feed2.setMl(Integer.parseInt(feedML.getText().toString()));
		feed2.setFeedName(feedNames[selectedRow]);
	...
	public class FeedListAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			feedIcon.setVisibility(View.INVISIBLE);

			if (selectedRow == position) {
				Log.d(LOG_TAG, "selected Row " + selectedRow);
				feedIcon.setVisibility(View.VISIBLE);
			}
			return convertView;
