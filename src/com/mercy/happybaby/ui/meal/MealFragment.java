...
public class MealFragment extends Fragment {
	String LOG_TAG = MealFragment.class.getName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			...
			where.isNotNull("breast_id");
			where.or();
			where.isNotNull("feed_id");
			where.or();
			where.isNotNull("formula_id");
			where.or();
		...
		View root = inflater.inflate(R.layout.meal_view, container, false);
		...
		MealAdapter adapter = new MealAdapter(getActivity(), list);
