...
public class SetupActivity extends FragmentActivity {
	...
	private void launchMainActivity(boolean isInit) {
		intent = new Intent(this, MainActivity.class);
		Bundle mBundle = new Bundle();
		if (isInit) {
			mBundle.putBoolean("isInit", isInit);
		}
	...
	private void setDateData() {
		try {
			...
			Calendar growthCal10 = Calendar.getInstance();
			growth10.setCreatedDate(growthCal10.getTime());
			growth10.setMonth(1);
			growth10.setHeight(35f);
			growth10.setWeight(51f);
			growth10.setHeadCirc(3500f);
			Timeline growthTimeline10 = new Timeline();
			growthTimeline10.setGrowth(growth10);
			growthTimeline10.setCreatedDate(growthCal10.getTime());
			timelineDAO = getHelper().getTimelineDao();
			timelineDAO.create(growthTimeline10);
			...
			growth0.setHeight(51);
			growth0.setWeight(3500);
			growth0.setMonth(0);
			...
			growth1.setHeight(54);
			growth1.setWeight(4100);
			growth1.setMonth(1);
			...
			growth2.setHeight(58);
			growth2.setWeight(5400);
			growth2.setMonth(2);
			...
			growth3.setHeight(60);
			growth3.setWeight(6500);
			growth3.setMonth(3);
			...
			growth4.setHeight(62);
			growth4.setWeight(7200);
			growth4.setMonth(4);
			...
			growth5.setHeight(63);
			growth5.setWeight(7600);
			growth5.setMonth(5);
			...
			growth6.setHeight(65);
			growth6.setWeight(7800);
			growth6.setMonth(6);
			...
			growth7.setHeight(66);
			growth7.setWeight(8100);
			growth7.setMonth(7);
			...
			growth8.setHeight(67);
			growth8.setWeight(8200);
			growth8.setMonth(8);
			...
			growth9.setHeight(69);
			growth9.setWeight(8700);
			growth9.setMonth(9);
