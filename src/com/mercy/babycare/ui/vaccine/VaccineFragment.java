package com.mercy.babycare.ui.vaccine;
...
public class VaccineFragment extends Fragment {
	String LOG_TAG = VaccineFragment.class.getName();

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.vaccine_view, container, false);
		...
		VaccineAdapter adapter = new VaccineAdapter(getActivity(),
