package com.mercy.babycare.ui.vitamin;
...
public class VitaminFragment extends Fragment {
	String LOG_TAG = VitaminFragment.class.getName();

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.vitamin_view, container, false);
		...
		VitaminAdapter adapter = new VitaminAdapter(getActivity(),
