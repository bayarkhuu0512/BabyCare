package com.mercy.babycare.ui.formula;
...
public class FormulaFragment extends Fragment {
	String LOG_TAG = FormulaFragment.class.getName();

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.formula_view, container, false);
		...
		FormulaAdapter adapter = new FormulaAdapter(getActivity(),
