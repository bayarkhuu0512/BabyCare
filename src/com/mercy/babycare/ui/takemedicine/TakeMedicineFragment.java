...
public class TakeMedicineFragment extends Fragment {
	String LOG_TAG = TakeMedicineFragment.class.getName();

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View root = inflater.inflate(R.layout.takemedicine_view, container, false);
		...
		TakeMedicineAdapter adapter = new TakeMedicineAdapter(getActivity(),
